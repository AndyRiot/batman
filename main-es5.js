...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppPagesFilmsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function FilmsComponent_small_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilmsComponent_div_10_span_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilmsComponent_div_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilmsComponent_h3_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilmsComponent_ul_25_li_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilmsComponent_ul_25_Template(rf, ctx) {
      if (rf & 1) {
    ...
    FilmsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function FilmsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilmsComponent_Template_a_click_17_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilmsComponent_Template_a_click_40_listener($event) {
            return ctx.switchTab($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilmsComponent_Template_button_click_58_listener($event) {
  ...
  function srcAppPagesIndexTs(module, __webpack_exports__, __webpack_require__) {
    ...
    IndexComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [["id", "body-bg", 1, "parallax", "pure"], [1, "p-box"], [1, "p-img", 2, "background-image", "url('assets/bg.jpg')"], [1, "container", "index-wrap"], ["class", "film-card", 4, "ngFor", "ngForOf"], [1, "film-card"], [1, "film-card__link", 3, "routerLink", "title"], [1, "bookmark__add", 3, "title"], [3, "src", "alt"]],
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function parallaxDE(e) {
      document.querySelectorAll('.parallax.de .p-text').forEach(function (p) {
        // @ts-ignore
        p.style.transform = 'translate(' + (window.innerWidth / 2 - e.pageX) / 10 + 'px,' + (p.parentElement.clientHeight / 2 + (window.innerHeight / 2 - e.pageY) / 10) + 'px)';
      });
    }

    function parallaxPure() {
      document.querySelectorAll('.parallax.pure .p-img').forEach(function (img) {
        // @ts-ignore
        if (img.dataset.scale === 'out') {
          // @ts-ignore
          img.style.bottom = img.getBoundingClientRect().top + 'px'; // @ts-ignore
    ...
    function parallaxFade() {
      document.querySelectorAll('.parallax .p-img').forEach(function (img) {
        if (img.classList.contains('p-fade')) {
          // @ts-ignore
          img.style.opacity = ( // @ts-ignore
